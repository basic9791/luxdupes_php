...
function selectMainBox() {
  var list = [
...

    {
      ...
      fnm: "Women's Bags",
      child: [
        { fid: 21, fnm: "Alexander Wang" },
        { fid: 8, fnm: "Balenciaga" },
        { fid: 15, fnm: "Bottega Veneta" },
        { fid: 16, fnm: "Bulgari" },
        { fid: 11, fnm: "Burberry" },
        { fid: 10, fnm: "Celine" },
        { fid: 4, fnm: "Chanel" },
        ...
        { fid: 6, fnm: "Hermès" },
        { fid: 13, fnm: "Loewe" },
        { fid: 23, fnm: "Loro Piana" },
        { fid: 2, fnm: "Louis Vuitton" },
        { fid: 19, fnm: "MCM" },
        { fid: 12, fnm: "Miu Miu" },
        { fid: 9, fnm: "Prada" },
        { fid: 18, fnm: "Valentino" },
        { fid: 7, fnm: "YSL" },
      ],
    },

    {
      ...
      child: [
        { fid: 33, fnm: "Bally" },
        { fid: 31, fnm: "Bottega Veneta" },
        { fid: 30, fnm: "Burberry" },
        { fid: 27, fnm: "Dior" },
        { fid: 29, fnm: "Fendi" },
        { fid: 32, fnm: "Givenchy" },
        { fid: 26, fnm: "Gucci" },
        { fid: 25, fnm: "Louis Vuitton" },
        { fid: 35, fnm: "MCM" },
        { fid: 28, fnm: "Prada" },
        { fid: 34, fnm: "Thom Browne" },
      ],
    },
...

    {
      ...
      child: [
        { fid: 78, fnm: "Acne Studios" },
        { fid: 68, fnm: "Alexander Wang" },
        { fid: 79, fnm: "Armani" },
        { fid: 64, fnm: "Balenciaga" },
        { fid: 81, fnm: "Balmain" },
        { fid: 71, fnm: "Bottega Veneta" },
        { fid: 61, fnm: "Burberry" },
        { fid: 87, fnm: "Cashmere Coats, Furs" },
        { fid: 67, fnm: "Celine" },
        { fid: 56, fnm: "Chanel" },
        { fid: 73, fnm: "Chloé" },
        { fid: 72, fnm: "Chrome Hearts" },
        { fid: 58, fnm: "Dior" },
        { fid: 84, fnm: "Dolce &amp; Gabbana" },
        { fid: 66, fnm: "Fendi" },
        { fid: 69, fnm: "Givenchy" },
        ...
        { fid: 80, fnm: "Kenzo" },
        { fid: 63, fnm: "Loewe" },
        { fid: 370, fnm: "Louis Vuitton" },
        { fid: 83, fnm: "MaxMara" },
        { fid: 65, fnm: "Miu Miu" },
        { fid: 74, fnm: "Moncler" },
        { fid: 85, fnm: "Moschino" },
        { fid: 82, fnm: "OffWhite" },
        { fid: 90, fnm: "Other Brands of" },
        { fid: 62, fnm: "Prada" },
        { fid: 89, fnm: "Premium Women's Down Jackets" },
        { fid: 76, fnm: "The North Face" },
        { fid: 75, fnm: "Thom Browne" },
        { fid: 86, fnm: "Valentino" },
        { fid: 70, fnm: "Versace" },
        { fid: 60, fnm: "YSL" },
        { fid: 77, fnm: "Zimmermann" },
      ],
    },

    {
      ...
      child: [
        { fid: 101, fnm: "Armani" },
        { fid: 116, fnm: "Balenciaga" },
        { fid: 109, fnm: "Bottega Veneta" },
        { fid: 112, fnm: "Burberry" },
        { fid: 94, fnm: "Canada Goose" },
        { fid: 111, fnm: "Celine" },
        { fid: 119, fnm: "Chanel" },
        { fid: 102, fnm: "Chrome Hearts" },
        { fid: 120, fnm: "Dior" },
        { fid: 97, fnm: "Dolce &amp; Gabbana" },
        { fid: 115, fnm: "Fendi" },
        { fid: 104, fnm: "Givenchy" },
        { fid: 121, fnm: "Gucci" },
        { fid: 118, fnm: "Hermès" },
        { fid: 99, fnm: "Kenzo" },
        { fid: 114, fnm: "Loewe" },
        { fid: 122, fnm: "Louis Vuitton" },
        { fid: 105, fnm: "Mastermind Japan" },
        { fid: 110, fnm: "Moncler" },
        { fid: 98, fnm: "Moschino" },
        { fid: 100, fnm: "Off-White" },
        { fid: 95, fnm: "Other Brands of" },
        { fid: 117, fnm: "Prada" },
        { fid: 93, fnm: "Premium Men's Down Jackets" },
        { fid: 123, fnm: "Summer Shorts" },
        { fid: 107, fnm: "The North Face" },
        { fid: 108, fnm: "Thom Browne" },
        { fid: 96, fnm: "Valentino" },
        { fid: 103, fnm: "Versace" },
        { fid: 113, fnm: "YSL" },
        { fid: 106, fnm: "Zegna" },
      ],
...

    {
      ...
      fnm: "Women's Shoes",
      child: [
        { fid: 168, fnm: "AIR JORDAN" },
        { fid: 167, fnm: "Alexander Wang" },
        { fid: 166, fnm: "Amiri" },
        { fid: 165, fnm: "Balenciaga" },
        { fid: 164, fnm: "Bally" },
        { fid: 163, fnm: "Balmain" },
        { fid: 162, fnm: "Bottega Veneta" },
        { fid: 161, fnm: "Brunello Cucinelli" },
        { fid: 160, fnm: "Burberry" },
        { fid: 159, fnm: "Celine" },
        { fid: 158, fnm: "Chanel" },
        { fid: 157, fnm: "Chloé" },
        { fid: 156, fnm: "Christian Louboutin" },
        { fid: 155, fnm: "Dior" },
        { fid: 154, fnm: "Dolce &amp; Gabbana" },
        { fid: 153, fnm: "Fendi" },
        { fid: 152, fnm: "Ferragamo" },
        { fid: 151, fnm: "Givenchy" },
        { fid: 150, fnm: "Golden Goose" },
        { fid: 149, fnm: "Gucci" },
        { fid: 147, fnm: "HOGAN" },
        { fid: 148, fnm: "Hermès" },
        { fid: 146, fnm: "JIL SANDER" },
        { fid: 145, fnm: "Jimmy Choo" },
        { fid: 144, fnm: "LANVIN" },
        { fid: 143, fnm: "Loewe" },
        { fid: 142, fnm: "Loro Piana" },
        { fid: 141, fnm: "Louis Vuitton" },
        { fid: 140, fnm: "Maison Margiela" },
        { fid: 139, fnm: "Manolo Blahnik" },
        { fid: 138, fnm: "Marni" },
        { fid: 137, fnm: "McQueen" },
        { fid: 136, fnm: "Miu Miu" },
        { fid: 134, fnm: "Other Brands of" },
        { fid: 133, fnm: "Prada" },
        { fid: 132, fnm: "Rick Owens" },
        { fid: 131, fnm: "Roger Vivier" },
        { fid: 130, fnm: "Sergio Rossi" },
        { fid: 129, fnm: "TODS" },
        { fid: 128, fnm: "UGG" },
        { fid: 127, fnm: "Valentino" },
        { fid: 371, fnm: "Versace" },
        { fid: 125, fnm: "YSL" },
        { fid: 126, fnm: "Yeezy" },
      ],
...

    {
      ...
      child: [
        { fid: 203, fnm: "AJ" },
        { fid: 202, fnm: "Armani" },
        { fid: 201, fnm: "Balenciaga" },
        { fid: 200, fnm: "Bally" },
        { fid: 199, fnm: "Balmain" },
        { fid: 198, fnm: "Basketball Shoes for Real Games" },
        { fid: 197, fnm: "Berluti" },
        { fid: 196, fnm: "Bottega Veneta" },
        { fid: 195, fnm: "Burberry" },
        { fid: 194, fnm: "Celine" },
        { fid: 193, fnm: "Chanel" },
        { fid: 192, fnm: "Dior" },
        { fid: 191, fnm: "Dolce &amp; Gabbana" },
        { fid: 190, fnm: "Fendi" },
        { fid: 189, fnm: "Ferragamo" },
        { fid: 188, fnm: "Givenchy" },
        { fid: 187, fnm: "Gucci" },
        { fid: 186, fnm: "Hermès" },
        { fid: 185, fnm: "Kenzo" },
        { fid: 184, fnm: "Loewe" },
        { fid: 183, fnm: "Louis Vuitton" },
        { fid: 182, fnm: "McQueen" },
        { fid: 181, fnm: "Moncler" },
        { fid: 180, fnm: "Off-White" },
        { fid: 179, fnm: "Other Brands of" },
        { fid: 178, fnm: "Prada" },
        { fid: 176, fnm: "TOD'S" },
        { fid: 177, fnm: "Thom Browne" },
        { fid: 175, fnm: "UGG" },
        { fid: 174, fnm: "Valentino" },
        { fid: 173, fnm: "Versace" },
        { fid: 171, fnm: "YSL" },
        { fid: 172, fnm: "Yeezy" },
        { fid: 170, fnm: "Zegna" },
...

    {
      ...
      child: [
        { fid: 221, fnm: "AJ" },
        { fid: 223, fnm: "Adidas Originals" },
        { fid: 222, fnm: "Air Force" },
        { fid: 220, fnm: "Asics" },
        { fid: 219, fnm: "Converse" },
        { fid: 218, fnm: "Dunk" },
        { fid: 217, fnm: "Ecco" },
        { fid: 216, fnm: "GGCC" },
        { fid: 214, fnm: "MLB" },
        { fid: 215, fnm: "Mihara Yasuhiro" },
        { fid: 213, fnm: "New Balance" },
        { fid: 211, fnm: "Puma" },
        { fid: 210, fnm: "Rick Owens" },
        { fid: 209, fnm: "Salomon" },
        { fid: 208, fnm: "Sandals and Slippers" },
        { fid: 207, fnm: "Timberland" },
        { fid: 206, fnm: "Vans" },
        { fid: 205, fnm: "Yeezy" },
      ],
    },

    {
      ...
      fnm: "Belts",
      child: [
        { fid: 367, fnm: "Balenciaga" },
        { fid: 366, fnm: "Bottega Veneta" },
        { fid: 365, fnm: "Burberry" },
        { fid: 364, fnm: "Celine" },
        { fid: 363, fnm: "Chanel" },
        { fid: 362, fnm: "Dior" },
        { fid: 361, fnm: "Fendi" },
        { fid: 360, fnm: "Ferragamo" },
        { fid: 359, fnm: "Gucci" },
        { fid: 358, fnm: "Hermès" },
        { fid: 356, fnm: "LV" },
        { fid: 357, fnm: "Loewe" },
        { fid: 355, fnm: "Miu Miu" },
        { fid: 354, fnm: "Montblanc" },
        { fid: 353, fnm: "Prada" },
        { fid: 352, fnm: "Valentino" },
        { fid: 351, fnm: "Versace" },
        { fid: 350, fnm: "YSL" },
      ],
    },
...

    {
      ...
      fnm: "Eyewear",
      child: [
        { fid: 326, fnm: "Balenciaga" },
        { fid: 325, fnm: "Burberry" },
        { fid: 324, fnm: "Cartier" },
        { fid: 323, fnm: "Celine" },
        { fid: 322, fnm: "Chanel" },
        { fid: 321, fnm: "Dior" },
        ...
        { fid: 315, fnm: "LV" },
        { fid: 317, fnm: "Loewe" },
        { fid: 316, fnm: "Louis Vuitton" },
        { fid: 314, fnm: "Miu Miu" },
        { fid: 313, fnm: "Montblanc" },
        { fid: 312, fnm: "Prada" },
        { fid: 311, fnm: "Versace" },
      ],
    },

    {
      ...
      fnm: "Hats",
      child: [
        { fid: 302, fnm: "Balenciaga" },
        { fid: 301, fnm: "Burberry" },
        { fid: 304, fnm: "Celine" },
        { fid: 306, fnm: "Chanel" },
        { fid: 297, fnm: "Chrome Hearts" },
        { fid: 307, fnm: "Dior" },
        { fid: 298, fnm: "Fendi" },
        { fid: 308, fnm: "Gucci" },
        { fid: 309, fnm: "LV" },
...

    {
      ...
      child: [
        ...
        { fid: 284, fnm: "Gucci" },
        { fid: 283, fnm: "Hermès" },
        { fid: 282, fnm: "Louis Vuitton" },
        { fid: 281, fnm: "Miu Miu" },
        { fid: 280, fnm: "Niche" },
        { fid: 279, fnm: "Qeelin" },
        { fid: 278, fnm: "Tiffany &amp; Co." },
        { fid: 277, fnm: "Van Cleef &amp; Arpels" },
        { fid: 276, fnm: "Vivienne Westwood" },
        { fid: 275, fnm: "YSL" },
      ],
    },

    {
      ...
      child: [
        { fid: 368, fnm: "Armani" },
        { fid: 273, fnm: "Audemars Piguet" },
        { fid: 268, fnm: "BVLGARI" },
        { fid: 272, fnm: "Bell &amp; Ross" },
        { fid: 271, fnm: "Blancpain" },
        { fid: 270, fnm: "Breguet" },
        { fid: 269, fnm: "Breitling" },
        { fid: 266, fnm: "CASIO" },
        { fid: 265, fnm: "CHANEL" },
        { fid: 264, fnm: "Chopard" },
        { fid: 263, fnm: "Corum" },
        { fid: 260, fnm: "FRANCK MULLER" },
        { fid: 261, fnm: "Ferragamo" },
        { fid: 259, fnm: "Girard - Perregaux" },
        { fid: 258, fnm: "Glashütte Original" },
        { fid: 257, fnm: "Grand Seiko" },
        { fid: 256, fnm: "Gucci" },
        { fid: 254, fnm: "HUBLOT" },
        { fid: 253, fnm: "IWC" },
        { fid: 252, fnm: "JAEGER - LECOULTRE" },
        { fid: 251, fnm: "Joker" },
        { fid: 248, fnm: "LONGINES" },
        { fid: 250, fnm: "Ladies" },
        { fid: 249, fnm: "Lange &amp; Söhne" },
        { fid: 245, fnm: "MIDO" },
        { fid: 246, fnm: "Maurice Lacroix" },
        { fid: 244, fnm: "Montblanc" },
        { fid: 243, fnm: "NOMOS" },
        { fid: 242, fnm: "OMEGA" },
        { fid: 241, fnm: "ORIS" },
        { fid: 239, fnm: "PARMIGIANI" },
        { fid: 238, fnm: "PATEK PHILIPPE" },
        { fid: 237, fnm: "PIAGET" },
        { fid: 240, fnm: "Panerai" },
        { fid: 233, fnm: "ROLEX" },
        { fid: 235, fnm: "Richard Mille" },
        { fid: 234, fnm: "Roger Dubuis" },
        { fid: 232, fnm: "SevenFriday" },
        { fid: 231, fnm: "TAG Heuer" },
        { fid: 230, fnm: "TISSOT" },
        { fid: 229, fnm: "TUDOR" },
        { fid: 228, fnm: "ULYSSE NARDIN" },
        { fid: 227, fnm: "Vacheron Constantin" },
        { fid: 226, fnm: "Van Cleef &amp; Arpels" },
        { fid: 225, fnm: "ZENITH" },
      ],
    },
