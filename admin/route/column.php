...
switch ($action) {
    ...
    case 'update':
        ...
        if ('GET' == $method) {
            ...
            $name = strtr($_forum['name'], $replacements);
            $seo_title = strtr($_forum['seo_title'], $replacements);
            $seo_keywords = strtr($_forum['seo_keywords'], $replacements);
