...
if (!xn_bg.isset(tinymce_path)) tinymce_path = '';
tinymce.init({
    selector: '#message',
    auto_focus: true,
    content_css: tinymce_path + 'plugin/huux_tinymce/tinymce/style.css', /*编辑内容区附加css文件*/
    language_url: tinymce_path + 'plugin/huux_tinymce/tinymce/langs/zh_CN.js',
    entity_encoding : "raw",
    ...
    */
    ...
    images_upload_handler: function(blobInfo, success, failure) {
        ...
        xn_bg.upload_file(blobInfo.blob(), tinymce_upload, {
            is_image: 1,
            filetype: 'jpeg'
        }, function(code, json) {
            if (code == 0) {
